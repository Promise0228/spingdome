	...
	<div class="container-fluid">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="row placeholders">
				<div>
					<form action="${pageContext.request.contextPath}/bug/noBug.action" method="get">
				...
				<table class="table table-hover table-bordered user-list">
					...
					<c:forEach items="${noBugList }" var="bug">
						<tr>
							...
							<td><c:if test="${bug.bugState!=3}">
								...
								<c:if test="${fn:contains(authcodes,'qiyong-jinyong')}">
									<c:if test="${bug.bugState==3 }">
										<input type="button" class="btn btn-primary qidong"
											value="启用" />
									</c:if>
								</c:if></td>
						</tr>

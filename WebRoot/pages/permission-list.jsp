                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="permissionDesc" class="form-control" id="descInput" placeholder="权限描述">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="checkbox">
                            <label>
                            	<input type="checkbox" name="isNavi" value="1" >是否导航结点
                           	</label>
                          </div>
                          <div class="form-group">
                            <label for="codeInput">权限代码</label>
                            <input type="text" name="permissionCode" class="form-control" id="codeInput" placeholder="权限代码">
                          </div>
                        </form>
                      </div>
                      <div class="modal-footer">
		...
		$(".perm-list").on("click",".show-perminfo-form",function(){
			...
			$.ajax({
				...
				success:function(data){
					...
					if(data.isNavi===1){
						$(".perm-form input[type='checkbox'][name='isNavi']").prop("checked",true);
					}
				...
				$.ajax({
					...
					success:function(data){
						...
						var newTr='<tr>'+
	                        ...
	                        '<td class="permid">'+data.permissionId+'</td>'+
	                        '<td>'+data.permissionDesc+'</td>'+
	                        '<td>'+data.url+'</td>'+
	                        '<td>'+data.isNavi+'</td>'+

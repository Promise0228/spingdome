  ...
  <head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/zTree/js/jquery.ztree.excheck.js"></script>
  	<script type="text/javascript">
        ...
        var zNodes =[
            { id:1, pId:0, name:"随意勾选 1", open:false,authGrade:1},
            { id:11, pId:1, name:"随意勾选 1-1", open:true,authGrade:2},
            { id:111, pId:11, name:"随意勾选 1-1-1",authGrade:3},
            ...
            function onCheck(e,treeId,treeNode){
         	var treeObj=$.fn.zTree.getZTreeObj("treeDemo"),
            	...
            	for(var i=0;i<nodes.length;i++){
            		v+=nodes[i].id + ",";
            		//alert(nodes[i].authGrade); //获取选中节点的值,权限级别
            	}
           	 	alert(v)
            }

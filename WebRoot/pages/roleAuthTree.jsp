 ...
 <script type="text/javascript">
       var setting = {          
        ...
        var treeObj=$.fn.zTree.getZTreeObj("treeDemo"),
          ...
          $.ajax({
					url:"${pageContext.request.contextPath}/role-Auth/addRoleAuth.action",
					dataType:"json",
					type:"POST",
					data:{
					roleId:roleId,
					...
					success:function(data){
						if(data.msg=='1'){
						alert("添加成功！");
					   window.location.href="${pageContext.request.contextPath}/role/updateRole.action?roleId="+roleId+"";						
						}else{
						alert("添加失败！");
					   window.location.href="${pageContext.request.contextPath}/role/updateRole.action?roleId="+roleId+"";						
						}
